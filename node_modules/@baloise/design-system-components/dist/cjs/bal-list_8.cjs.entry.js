...
const List = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "list", class: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, block.class()), block.modifier('nested').class(nested)), block.modifier('disabled').class(this.disabled)), block.modifier('border').class(this.border)), block.modifier(`size-${this.size}`).class(this.size !== '')), block.modifier(`background-${this.background}`).class()) }, index.h("slot", null)));
  }

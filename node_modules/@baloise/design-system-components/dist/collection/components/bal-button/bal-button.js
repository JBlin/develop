...
export class Button {
  ...
  render() {
    ...
    return (h(Host, { onClick: this.handleClick, class: {
        ...
        'is-small': this.size === 'small',
      }, style: { opacity: this.loading || (this.square && this.icon !== '') ? '0' : '1' }, "data-testid": "bal-button-label" }, h("slot", null)), h("bal-icon", Object.assign({}, this.leftRightAttrs, { class: "icon-right", name: this.iconRight, size: 'small', turn: this.iconTurn, inverted: this.isIconInverted })))));
  }

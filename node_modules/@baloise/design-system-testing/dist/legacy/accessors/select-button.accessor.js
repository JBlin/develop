...
exports.SelectButtonAccessor = exports.SelectButtonSelectableMixin = void 0;
...
var SelectButtonSelectableMixin = function (_a) {
    ...
    return ({
        select: function (indexes) {
            ...
            cy.get(selector).within(function () {
                ;
                indexes.forEach(function (index) { return cy.get("bal-radio").eq(index).check(); });
            });
            return creator();
        },
        assertIsSelected: function (indexes) {
            ...
            cy.get(selector).within(function () {
                ;
                indexes.forEach(function (index) { return cy.get("bal-radio").eq(index).should('be.checked'); });
            });
            return creator();
        },
    });
};
exports.SelectButtonSelectableMixin = SelectButtonSelectableMixin;
exports.SelectButtonAccessor = (0, mixins_1.createAccessor)(andable_1.AndableMixin, blurable_1.BlurableMixin, exports.SelectButtonSelectableMixin, containable_1.ContainableMixin, clickable_1.ClickableMixin, existable_1.ExistableMixin, shouldable_1.ShouldableMixin, visible_1.VisibleMixin, disableable_1.DisableableMixin, nthSelectable_1.NthSelectableMixin, attributable_1.AttributableMixin, urlable_1.UrlableMixin, waitable_1.WaitableMixin, findable_1.FindableMixin, invokable_1.InvokableMixin, thenable_1.ThenableMixin, lengthable_1.LengthableMixin, eachable_1.EachableMixin);
